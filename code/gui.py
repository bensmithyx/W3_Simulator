...
pods_to_draw = [Circle('living_quarters_background',colour,(600,500),190,0),Circle('living_quarters_outline',black,(600,500),190,5),Circle('connecting_corridor_background',colour, (980, 500), 190, 0),Circle('connecting_corridor_outline',black, (980, 500), 190, 5),Circle('Engineering_background',colour, (1360, 500), 190, 0),Circle('Engineering_outline',black, (1360, 500), 190, 5),Circle('food_production_background',black, (980, 500), 100, 5),Circle('food_production_outline',colour, (980, 215), 100, 0),Circle('life_support_background',black, (980, 215), 100, 5),Circle('life_support_outline',colour, (980, 785), 100, 0),Circle('comms_and_control_centre_background',colour, (980, 785), 100, 0),Circle('comms_and_control_centre_outline',black, (980, 785), 100, 5),Circle('bio-research_background',colour, (1360, 215), 100, 0),Circle('bio-research_outline',black, (1360, 215), 100, 5),Circle('storage_(external)_background',colour, (200, 800), 100, 0),Circle('storage_(external)_outline',black, (200, 800), 100, 5),Circle('emergency_quarters_background',colour,(220, 250), 190, 0),Circle('emergency_quarters_outline',black,(220, 250), 190, 5)]

# Making the doors
doors_to_draw = [Door(1,'living_quarters_left_door',doorcolour,(410,425,30,150)),Door(1,'living_quarters_top_door',doorcolour,(525,300,150,30)),Door(1,'living_quarters_right_door',doorcolour,(780,425,30,150)),Door(1,'living_quarters_bottom_door',doorcolour,(525,670,150,30)),Door(2,'connecting_corridor_right_door',doorcolour,(1155,425,30,150)),Door(2,'connecting_corridor_top_door',doorcolour,(905,300,150,30)),Door(2,'connecting_corridor_bottom_door',doorcolour,(905,670,150,30)),Door(3,'comms_bottom_door',doorcolour,(1055,425,30,150)),Door(3,'comms_top_door',doorcolour,(875,425,30,150)),Door(4,'engineering_bottom_door',doorcolour,(1280,670,150,30)),Door(4,'engineering_right_door',doorcolour,(1525,425,30,150)),Door(4,'engineering_top_door',doorcolour,(1285,300,150,30)),Door(5,'bio-research_top_door',doorcolour,(1285,115,150,30)),Door(6,'food_production_top_door',doorcolour,(900,115,150,30)),Door(7,'life_support_bottom_door',doorcolour,(905,865,150,30)),Door(8,'storage_external_top_door',doorcolour,(125,700,150,30)),Door(9,'emergency_quarters_top_door',doorcolour,(145,60,150,30)),Door(9,'emergency_quarters_bottom_door',doorcolour,(145,420,150,30)),Door(9,'emergency_quarters_left_door',doorcolour,(25,180,30,150)),Door(9,'emergency_quarters_right_door',doorcolour,(380,180,30,150))]
...
while run:
    ...
    # Draws pod backgrounds to the screen
